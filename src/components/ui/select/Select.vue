    ...
    >
      <SelectGroup class="p-1">
        <SelectItem
          ...
          :key="option.value"
          :value="option.value"
          class="relative flex w-full select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 cursor-pointer"
        >
          {{ option.label }}
        </SelectItem>
      </SelectGroup>
